...
v1.0 breadboard has no hardware stack or frame pointer. **S5 Subset C** therefore targets **static allocation**: locals and parameters live in **fixed RAM cells** at compile time; **unbounded recursion** is out of scope. See [swiver-whitepaper.md](../../swiver-whitepaper.md) §2.3.1.
